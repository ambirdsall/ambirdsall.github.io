---
path: "/blag/on-the-sierpinski-triangle-thing"
title: "On that fractal triforce thing there"
topic: M E T A B L A G
date: 2024-05-09 14:38:05 UTC
---

import Triangle from "../components/triangle"
import Vertices from "../components/vertices"
import StaticTriangle from "../components/static-triangle"
